...
public interface ExpenseRepository extends JpaRepository<ExpenseEntity,Long> {
    ...
    List<ExpenseEntity> findByProfileIdAndDateBetweenAndNameContainingIgnoreCase(Long profileId, LocalDateTime startDate, LocalDateTime endDate, String name , Sort sort);
